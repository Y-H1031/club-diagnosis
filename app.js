...
// =========================
const clubs = [
  { name: "水泳部", type: "sports", data: [3, 1, 4, 4, 5, 3] },
  { name: "テニスサークルA", type: "sports", data: [2, 3, 2, 2, 2, 4] },
  { name: "テニスサークルB", type: "sports", data: [4, 5, 3, 3, 3, 2] },
  { name: "ボランティア部A", type: "volunteer", data: [3, 2, 1, 3, 3, 1] },
  { name: "ボランティア部B", type: "volunteer", data: [4, 3, 2, 2, 2, 1] },
  { name: "ボランティア部C", type: "volunteer", data: [3, 4, 1, 1, 1, 2] },
  { name: "写真部", type: "culture", data: [2, 1, 2, 3, 2, 5] },
  { name: "軽音部", type: "culture", data: [2, 2, 4, 4, 3, 4] },
  { name: "美術部", type: "culture", data: [4, 5, 1, 2, 1, 3] },
